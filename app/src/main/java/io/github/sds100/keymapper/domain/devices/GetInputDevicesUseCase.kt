...
class GetInputDevicesUseCaseImpl(
    ...
    private val externalInputDeviceAdapter: ExternalInputDeviceAdapter
    ...
    override val devices: StateFlow<List<DeviceInfo>> = externalInputDeviceAdapter.devices
    ...
    override suspend fun getDeviceName(descriptor: String) =
        deviceInfoCache.getDeviceName(descriptor).otherwise {
            externalInputDeviceAdapter.getDeviceName(descriptor)
        }.then { name ->
