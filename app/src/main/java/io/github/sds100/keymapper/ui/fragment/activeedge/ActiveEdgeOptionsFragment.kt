 ...
 */
class ActiveEdgeOptionsFragment : DefaultRecyclerViewFragment() {

    val optionsViewModel: BaseOptionsViewModel<ActiveEdgeOptions> by lazy {
        navGraphViewModels<ConfigActiveEdgeViewModel>(R.id.nav_config_active_edge) {
