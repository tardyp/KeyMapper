package io.github.sds100.keymapper.intents
...
class ConfigIntentViewModel : ViewModel() {
    ...
    private val _extrasListItemModels =
        MutableLiveData<OldDataState<List<IntentExtraListItemModel>>>(Empty())
    val extrasListItemModels: LiveData<OldDataState<List<IntentExtraListItemModel>>> =
