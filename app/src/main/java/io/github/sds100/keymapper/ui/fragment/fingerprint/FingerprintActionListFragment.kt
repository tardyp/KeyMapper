...
class FingerprintActionListFragment :
    ActionListFragment<FingerprintActionOptions, FingerprintMapAction>() {
    ...
    override val actionListViewModel: ActionListViewModel<FingerprintMapAction, FingerprintMap>
