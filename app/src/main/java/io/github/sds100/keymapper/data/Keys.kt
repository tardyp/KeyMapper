 ...
 */
 object Keys {
    ...
    val changeImeOnBtConnect = booleanPreferencesKey("pref_auto_change_ime_on_connect_disconnect")
    val showImePickerOnBtConnect = booleanPreferencesKey("pref_auto_show_ime_picker")
